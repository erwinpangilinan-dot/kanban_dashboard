...
title: Samsung UDU/VDU application deployment
task_triggers: ["Samsung application deployment", "SS deployment", "Samsung software deployment", "UDU deployment", "VDU deployment", "Atlas deployment", "Zero Touch Deployment"]
entities: ["Network Equipment", "Mission Control Dashboard", "Samsung", "Atlas", "Zero Touch Deployment"]
---
...
**mop_id:** `samsung-udu-vdu-application-deployment`
**Triggers:** Samsung application deployment, SS deployment, Samsung software deployment, UDU deployment, VDU deployment, Atlas deployment, Zero Touch Deployment
...
## Launch Atlas workflow job template
